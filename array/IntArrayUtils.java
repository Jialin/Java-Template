...
public class IntArrayUtils {
  ...
  public static void sort(int[] primary, int[]... secondaries) {
    sort(primary, 0, primary.length, secondaries);
  }

  public static void sort(int[] primary, int fromIdx, int toIdx, int[]... secondaries) {
    if (fromIdx + 1 >= toIdx) {
      return;
    }
  ...
  private static int compare(int[] primary, int x, int y, int[]... secondaries) {
